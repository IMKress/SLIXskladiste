        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipDokumentaId = table.Column<string>(maxLength: 10, nullable: false),
                    TipDokumentaNaziv = table.Column<string>(maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ArtiklId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ArtiklNaziv = table.Column<string>(nullable: true),
                    ArtiklJmj = table.Column<string>(nullable: true),
                    KategorijaId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "ArtikliDokumenata",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DokumentId = table.Column<int>(nullable: false),
                    Rb = table.Column<int>(nullable: false),
                    Jmj = table.Column<string>(nullable: true),
                    Kolicina = table.Column<float>(nullable: false),
                    Cijena = table.Column<float>(nullable: false),
                    UkupnaKolicina = table.Column<float>(nullable: false),
                    ArtiklId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtikliDokumenata", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ArtikliDokumenata_Artikli_ArtiklId",
                        column: x => x.ArtiklId,
                        principalTable: "Artikli",
                        principalColumn: "ArtiklId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArtikliDokumenata_Dokumenti_DokumentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArtikliDokumenata_ArtiklId",
                table: "ArtikliDokumenata",
                column: "ArtiklId");

            migrationBuilder.CreateIndex(
                name: "IX_ArtikliDokumenata_DokumentId",
                table: "ArtikliDokumenata",
                column: "DokumentId");
